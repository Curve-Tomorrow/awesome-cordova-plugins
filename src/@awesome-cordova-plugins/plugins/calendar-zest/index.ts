 ...
 * @usage
 * ```typescript
 * import { CalendarZest } from '@awesome-cordova-plugins/calendar-zest';
 *
 *
 * constructor(private calendarZest: CalendarZest) { }
 *
 * ...
 *
 *
 * this.calendarZest.functionName('Hello', 123)
...
@Plugin({
  ...
  repo: 'https://github.com/Curve-Tomorrow/Calendar-PhoneGap-Plugin',
